...
interface DadosDenuncia { idAnuncio : string, imagem : string, nomeAnuncio : string, descricao : string, anunciante : string, 
...
const AvaliarDenunciaCard: React.FC<DadosDenuncia> = ({idAnuncio, imagem, nomeAnuncio, descricao, anunciante,
    ...
    return (
      <div className="container p-3 my-3 border bg-light-gray" id="anuncio1">
                <div className="media">
                    <img className="align-self-center mr-3" src={imagem} width = {400} alt="Imagem de exemplo genérica"/>
