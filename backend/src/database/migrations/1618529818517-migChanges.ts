...
export class migChanges1618529818517 implements MigrationInterface {
    name = 'migChanges1618529818517'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "notificacoes" ("idNotificacao" uuid NOT NULL DEFAULT uuid_generate_v4(), "texto" character varying NOT NULL, "anuncioId" uuid, "ofertanteId" uuid, "anuncianteId" uuid, CONSTRAINT "PK_26e93d32ef169d3481c8700f506" PRIMARY KEY ("idNotificacao"))`);
        await queryRunner.query(`CREATE TABLE "clientes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "endereco" character varying NOT NULL, "cpf" character varying NOT NULL, "cidade" character varying NOT NULL, "estado" character varying NOT NULL, "dataNasc" character varying NOT NULL, "email" character varying NOT NULL, "senha" character varying NOT NULL, "nota" integer, "numTrocas" integer, CONSTRAINT "PK_d76bf3571d906e4e86470482c08" PRIMARY KEY ("id"))`);
